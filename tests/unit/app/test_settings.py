...
def test_funding_monitor_settings_are_loaded_from_environment(
    ...
    monkeypatch.setenv("CHOXR_FUNDING_SUMMARY_INTERVAL_SECONDS", "900")
    ...
    assert settings.funding_summary_interval_seconds == 900
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"funding_summary_interval_seconds": 0}, "summary_interval"),
